...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { content: @practice.content, date: @practice.date, hours: @practice.hours, student_id: @practice.student_id } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { content: @practice.content, date: @practice.date, hours: @practice.hours, student_id: @practice.student_id } }
